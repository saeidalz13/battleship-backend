-- name: AnalyticsIncrementGamesCreatedCount :exec
...
-- name: AnalyticsIncrementRematchCalledCount :exec
...
-- name: AnalyticsGetGamesCreatedCount :one
SELECT games_created FROM game_server_analytics WHERE server_ip = $1;

-- name: AnalyticsGetRematchCalledCount :one
